...
*/
var $nobyda = nobyda();
var cookieVal = $nobyda.read("SG_FW_VER=1.26.3; SP_FW_VER=3.230.36; BAIDUCUID=gaHUalut28g9uHihlPSOaluKSi_qu2a-YuHgu_iCv8l8aHt_j8Sfa0ipQM5KiHRK91nmA; BDUSS=k5aWjJocTZ5cX5OYmVrTUlsTjl3YjBqVjlpN1psTnlDR0htaDN0U01TZGdCWnRkRVFBQUFBJCQAAAAAAAAAAAEAAABB4GcBc2hhbmdqaWF6aQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAGB4c11geHNdc; BAIDUID=010A4E32537EE0B212521FEE07E35F4F:FG=1; BAIDU_WISE_UID=wapp_1563578648910_946");
...
function signTieBa() {
  ...
  if (!cookieVal) {
	...
	console.log(`未获取到cookie: ${$nobyda.notify} ${Details}`)
    return $nobyda.done()
  }
